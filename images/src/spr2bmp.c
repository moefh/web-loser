...
static int bmp_putw(int w, FILE *f)
{
  int b1, b2;
...
static long bmp_putl(long l, FILE *f)
{
  int b1, b2, b3, b4;
...
static int write_bmp(XBITMAP *bmp, char *filename)
{
  ...
  bmp_putw(0x4D42, f);                     /* bfType ("BM") */
  bmp_putl(54 + line_len * bmp->h, f);     /* bfSize */
  bmp_putw(0, f);                          /* bfReserved1 */
  bmp_putw(0, f);                          /* bfReserved2 */
  bmp_putl(54, f);                         /* bfOffBits */

  /* info_header */
  bmp_putl(40, f);                    /* biSize */
  bmp_putl(bmp->w, f);                /* biWidth */
  bmp_putl(bmp->h, f);                /* biHeight */
  bmp_putw(1, f);                     /* biPlanes */
  bmp_putw(24, f);                    /* biBitCount */
  bmp_putl(0, f);                     /* biCompression */
  bmp_putl(bmp->w * bmp->h * 3, f);   /* biSizeImage */
  bmp_putl(0, f);                     /* biXPelsPerMeter */
  bmp_putl(0, f);                     /* biYPelsPerMeter */
  bmp_putl(0, f);                     /* biClrUsed */
  bmp_putl(0, f);                     /* biClrImportant */
